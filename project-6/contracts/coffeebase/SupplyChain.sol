    ...
    RetailerRole
{
    ...
    function harvestItem(
        ...
        it.originFarmInformation = _originFarmInformation;
        ...
        checkValue(_upc)
    {
        ...
        // Emit the appropriate event
        emit Purchased(_upc);
        // Pay the retailer/distributor
        items[_upc].retailerID.transfer(items[_upc].productPrice);
        // Actually distributor doesn't get anything, screwing your partners is a way to success..
    }
